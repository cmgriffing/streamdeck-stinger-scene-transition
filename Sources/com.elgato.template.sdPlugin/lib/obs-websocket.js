var OBSWebSocket = (function () {
    ...
    E = /*#__PURE__*/ (function (n) {
      ...
      return (
        ...
        (s.disconnect = function () {
          try {
            var e = this;
            if (!e.socket || e.socket.readyState === b.CLOSED)
              return Promise.resolve();
        ...
        (s.reidentify = function (e) {
          try {
            ...
            return Promise.resolve(this.message(g.Reidentify, e)).then(
              function () {
                return t;
              }
            );
        ...
        (s.callBatch = function (t, n) {
          ...
          try {
            ...
            return Promise.resolve(
              this.message(g.RequestBatch, e({ requestId: o, requests: t }, n))
            ).then(function () {
          ...
          try {
            ...
            return (
              ...
              Promise.resolve(n).then(function () {
                ...
                if (n !== t.protocol)
                  throw new j(-1, "Server sent an invalid subprotocol");
                return r;
              })
            );
          } catch (e) {
  ...
  return (
    (A.OBSWebSocketError = j),
    (A.WebSocketOpCode = g),
    (A.EventSubscription = C),
    (A.RequestBatchExecutionType = w),
    A
  );
})();
